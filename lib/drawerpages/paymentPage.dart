...
import 'package:luckyblog/drawerpages/failedpayment.dart';
import 'package:luckyblog/drawerpages/successfulpayment.dart';
// import 'package:paystack_app/fail.dart';
// import 'package:paystack_app/success.dart';
...
String backendUrl = 'https://wwww.ocashup.com';
// Set this to a public key that matches the secret key you supplied while creating the heroku instance
String paystackPublicKey = 'pk_test_4da922bb1353fb60640cc9ece6f6bca489c74525';
const String appName = 'Flash News Payment Page';
...
class payPage extends StatefulWidget {
  ...
  String email;
  payPage({this.amount,this.subscriptionType,this.email});
...
class _payPageState extends State<payPage> {
            ...
            child: new ListBody(
              children: <Widget>[
                new Row(
                  ...
                  children: <Widget>[
                    new Expanded(
                      child:  Text(widget.subscriptionType),
                    ),
                    new Expanded(
                      child: new Column(
                ...
                _border,
                _verticalSizeBox,
                Text("You are about to pay the sum N${widget.amount} for Flash News Advert.\n To proceed : \nSelect payment method below \n then  clcik checkout",
                                    ...
                                    new Flexible(
                                      ...
                                      child: new Container(
                                        ...
                                        child: _getPlatformButton(
                                          'Checkout',
                                          () => _handleCheckout(context,widget.amount,widget.email),
                                        ),
                                      ),
                                    ),
                                  ],
  ...
  _handleCheckout(BuildContext context,int amount,String email) async {
    if (_method == null) {
    ...
    try {
      CheckoutResponse response = await PaystackPlugin.checkout(
        ...
        charge: charge,
        fullscreen: false,
        logo: Image.asset("assets/images/icon.png",width:30),
      );
      print('Response6 = $response');
      setState(() => _inProgress = false);
      _updateStatus(response.reference, '$response');
      if(response.verify==true && response.status == true && response.reference != null){
        print("succesful");
            Navigator.push(context, MaterialPageRoute(builder: (BuildContext)=>sucessfulPayment(),fullscreenDialog: true));


      }else{
      Navigator.push(context, MaterialPageRoute(builder: (BuildContext)=>failedPayment(),fullscreenDialog: true));
      }
  ...
  _chargeCard(Charge charge) {
    ...
    handleOnSuccess(Transaction transaction) {
      print('successfull0000');
      _verifyOnServer(transaction.reference);
       print('successfull');
    //  Navigator.push(context, MaterialPageRoute(builder: (BuildContext)=>success()));
